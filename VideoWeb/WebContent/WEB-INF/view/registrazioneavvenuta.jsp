...
<div class="col-sm-6">
 <div class="countainer">
<h1><span class="badge badge-warning">Benvenuto:${nickname}</span></h1>
...
<input type="submit" href="#loginModal" data-toggle="modal" value="ACCEDI">
 </div> 
 </div> 
...
<input type="password"   class="form-control"id="pwd1" name="pwd1" placeholder="Inserisci password" required >
